...
describe("check-content", () => {
    it("CheckContent - renderiza como 'Marcar como concluída' quando status: false", () => {
    ...
    it("CheckContent - renderiza como 'Desmarcar como concluída' quando status: true", () => {
    ...
    it("CheckContent - chama função 'mudarStatus' ao clicar", () => {
