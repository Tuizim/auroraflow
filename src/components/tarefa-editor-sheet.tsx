    ...
    return (
        <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent>
                ...
                <div className='p-4'>
                    <TarefaForm tarefa={tarefa} salvarTarefa={submitFormulario}></TarefaForm>
                </div>
                <SheetFooter>
                    <SheetClose asChild>
                        <Button className='cursor-pointer' variant='outline' type='reset' form='tarefa-form' tabIndex={5}>Cancelar</Button>
                    </SheetClose>
                    <Button className='cursor-pointer' type='submit' form='tarefa-form' tabIndex={4}>Salvar</Button>
                </SheetFooter>
            </SheetContent>
        </Sheet>
    )
